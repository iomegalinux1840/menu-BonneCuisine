...
ActiveRecord::Schema[7.1].define(version: 2025_11_15_014306) do
  ...
  create_table "restaurants", force: :cascade do |t|
    ...
    t.string "menu_font_size", default: "medium", null: false
    t.string "menu_font_color", default: "#f8fafc", null: false
    t.string "menu_background_color", default: "#0f172a", null: false
    t.string "menu_accent_color", default: "#facc15", null: false
